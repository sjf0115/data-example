...
/**
 * 功能：基于 Receiver 方式 消费 Kafka 数据  有问题-消费不到数据
 * 作者：SmartSi
...
public class KafkaReceiverExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SparkConf conf = new SparkConf().setAppName("KafkaReceiverExample").setMaster("local[*]");
        JavaSparkContext sparkContext = new JavaSparkContext(conf);
        JavaStreamingContext ssc = new JavaStreamingContext(sparkContext, Durations.seconds(60));
        ...
        String group = "spark-kafka-receiver";
...
//        }
//        // 合并输入流
//        JavaPairDStream<String, String> source = ssc.union(
//                kafkaStreams.get(0),
