...
/**
 * 功能：基于处理时间滚动窗口 提前触发输出
 * 作者：SmartSi
 * CSDN博客：https://smartsi.blog.csdn.net/
 * 公众号：大数据生态
 * 日期：2022/10/6 下午4:16
 */
public class EarlyFireProcessTimeTumbleWindowExample {
    public static void main(String[] args) {
        ...
        // 设置作业名称
        config.setString("pipeline.name", EarlyFireProcessTimeTumbleWindowExample.class.getSimpleName());
        // 窗口提前触发
