...
/**
 * 功能：基于处理时间 滑动分组窗口函数 SQL 示例
 * 作者：SmartSi
 * 博客：http://smartsi.club/
 * 公众号：大数据生态
 * 日期：2022/5/16 下午10:02
 */
public class ProcessTimeHopGroupWindowExample {
    public static void main(String[] args) {
        ...
        configuration.setString("pipeline.name", ProcessTimeHopGroupWindowExample.class.getSimpleName());
