...
/**
 * 功能：自定义实现 AssignerWithPeriodicWatermarks 接口实现周期性生成 Watermark 的时间戳分配器
 * 作者：SmartSi
...
public class CustomPeriodicWatermarkExample {
    private static final Logger LOG = LoggerFactory.getLogger(CustomPeriodicWatermarkExample.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Tuple3<String, Integer, String>> result = source
                .assignTimestampsAndWatermarks(new CustomBoundedOutOfOrderTimestampExtractor<Tuple4<Integer, String, Integer, Long>>(Time.seconds(5)) {
                    @Override
